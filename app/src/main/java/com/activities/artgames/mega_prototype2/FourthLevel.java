    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case (R.id.button1):
                ...
                break;
            case (R.id.button3):
                kekes[0][3].setBackgroundResource(R.mipmap.cons1y);
                kekes[0][2].setBackgroundResource(R.mipmap.cons10y);
                break;
            case (R.id.button4):
                kekes[0][3].setBackgroundResource(R.mipmap.cons10y);
                break;
            case (R.id.button5):
                kekes[0][4].setBackgroundResource(R.mipmap.start_yellow_selected);
                break;
            case (R.id.button6):
            ...
            case (R.id.button7):
                ...
                kekes[1][1].setBackgroundResource(R.mipmap.cons9);
                break;
            case (R.id.button8):
                kekes[0][2].setBackgroundResource(R.mipmap.cons4y);
                kekes[1][2].setBackgroundResource(R.mipmap.cons7y);
                break;
            case (R.id.button12):
                kekes[1][1].setBackgroundResource(R.mipmap.cons5);
                kekes[2][1].setBackgroundResource(R.mipmap.cons7);
                break;
            case (R.id.button13):
                kekes[1][2].setBackgroundResource(R.mipmap.cons2y);
                kekes[0][4].setBackgroundResource(R.mipmap.start_yellow_opened);
                kekes[2][2].setBackgroundResource(R.mipmap.finish_yellow_opened);
                break;
            case (R.id.button15):
                kekes[3][4].setBackgroundResource(R.mipmap.cons2b);
                kekes[2][4].setBackgroundResource(R.mipmap.finish_blue_opened);
                kekes[4][2].setBackgroundResource(R.mipmap.start_blue_opened);
                break;
            case (R.id.button16):
                kekes[3][0].setBackgroundResource(R.mipmap.cons10);
                kekes[3][1].setBackgroundResource(R.mipmap.cons6);
                break;
            case (R.id.button17):
                kekes[2][1].setBackgroundResource(R.mipmap.cons2);
                kekes[3][1].setBackgroundResource(R.mipmap.cons7);
                break;
            case (R.id.button20):
                kekes[3][4].setBackgroundResource(R.mipmap.cons8b);
                kekes[4][4].setBackgroundResource(R.mipmap.cons6b);
                break;
            case (R.id.button21):
                kekes[3][0].setBackgroundResource(R.mipmap.cons4);
                kekes[4][0].setBackgroundResource(R.mipmap.finish_black_opened);
                kekes[0][0].setBackgroundResource(R.mipmap.start_black_opened);
                break;
            case (R.id.button23):
                kekes[4][2].setBackgroundResource(R.mipmap.start_blue_selected);
                break;
            case (R.id.button24):
                kekes[4][3].setBackgroundResource(R.mipmap.cons9b);
                break;
            case (R.id.button25):
                kekes[4][3].setBackgroundResource(R.mipmap.cons1b);
                kekes[4][4].setBackgroundResource(R.mipmap.cons9b);
                break;
        }
    }
}
